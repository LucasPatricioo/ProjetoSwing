 ...
 * @author lucas
 */
public class FrmVerProjetoUsuario extends javax.swing.JFrame {

    private static int idProjeto;
    
    
    /**
     * Creates new form FrmVerProjetoUsuario
     */
    ...
    private void initComponents() {
        ...
        txtaDescProjeto.setFont(new java.awt.Font("Tahoma", 0, 22)); // NOI18N
        txtaDescProjeto.setForeground(new java.awt.Color(0, 0, 0));
        txtaDescProjeto.setRows(5);
        txtaDescProjeto.setEnabled(false);
    ...
    private void btnRequisitosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequisitosActionPerformed
        // TODO add your handling code here:
        FrmMenuRequisitosUsuario menuRequisitos = new FrmMenuRequisitosUsuario();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmVerProjetoUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmVerProjetoUsuario().setVisible(true);
            }
        });
    }
